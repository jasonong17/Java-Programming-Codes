...
class GCPC {
	public static void main(String[] args) {
		Kattiu io = new Kattiu(System.in, System.out);
   ...
   */
    ...
    */
    ...
    public AVLVertex rotateRight(AVLVertex T) {
    	...
    	int maxHeight1 = Math.max(height(T.left), height(T.right));
    	T.height = maxHeight1 + 1;

    	int maxHeight2 = Math.max(height(T), height(w.left));
    	w.height = maxHeight2 + 1;
    ...
    public AVLVertex rotateLeft(AVLVertex T) {
    	...
    	int maxHeight2 = Math.max(height(T), height(w.right));
    	w.height = maxHeight2 + 1;
...
class Kattiu extends PrintWriter {
    public Kattiu(InputStream i) {
       	super(new BufferedOutputStream(System.out));
       	r = new BufferedReader(new InputStreamReader(i));
   	}
   	public Kattiu(InputStream i, OutputStream o) {
